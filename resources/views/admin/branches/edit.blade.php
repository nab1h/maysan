                ...
                <form action="{{ route('admin.branches.update', $branch->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-5">
                        ...
                        <div>
                            ...
                            <input type="url" name="google_map_url" value="{{ old('google_map_url', $branch->google_map_url) }}" dir="ltr" class="w-full border border-gray-300 rounded-lg px-4 py-3 text-left text-sm focus:outline-none focus:ring-2 focus:ring-[#135158]/20 focus:border-[#135158] transition">
                        </div>
                    </div>
